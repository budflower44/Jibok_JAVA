...
public class EzenComputer_선생님풀이 {
	...
	//생성자
	public EzenComputer_선생님풀이() {}
	public EzenComputer_선생님풀이(String name, String phone, String branch) {
		this.name = name;
		this.phone = phone;
		this.branch = branch;
	}

	public EzenComputer_선생님풀이(String name, String birth, int age, String phone, String branch) {
