...
public class Class01 {
	...
	public static void main(String[] args) {
		...
		/* 접근제한자 (제어자)
		 * - public : 모두 사용 가능.
		 * - protected : 나(내 클래스) + 패키지 + 자식클래스 (주로 상속받을 때)
		 * - (default) 아무것도 안적을 때 : 나 + 패키지
		 * -private : 나
		 * 
		 * 클래스에서 public을 붙일 수 있는 건 파일명과 클래스명이 같을 때만 가능 (규칙)
		 * 멤버변수는 private, 메서드는 public (일반적)
		 * 
		 * private : 멤버변수 / 메서드를 다른 클래스에서 접근할 수 없게 함
		 * - private으로 선언된 멤버변수를 접근할 때는 getter / setter라는 메서드를 통해 접근할 수 있다.
		 * 
		 * */
